                                        ...
                                        {tradeDetailsForEachDay[
                                            day.format("DD-MM-YYYY")
                                                ...
                                                <div className=" absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex md:hidden gap-2 items-center">
                                                    <p
                                                        className={`md:text-[1rem] pt-4 md:pt-0 ${trades[
                                                                day.format(
                                                                    "DD-MM-YYYY"
                                                                )
                                                            ] !== undefined
                                                ...
                                                <HoverCard>
                                                    <HoverCardTrigger asChild>
                                                        <div className="hidden md:flex gap-1 absolute bottom-2">
                                                            ...
                                                            <div
                                                                className={`hidden md:flex shrink-0 px-3 py-1 text-[.7rem] flex-center rounded-full calendar-banner-shadow no-wrap ${trades[
                                                                        day.format(
                                                                            "DD-MM-YYYY"
                                                                        )
                                                                    ] !==
                                                            ...
                                                            {hasJournalEntry && (
                                                                <Link
                                                                    href={`/journal/${day.format("YYYY/MM/DD")}`}
