  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-0",
        caption_label: "flex justify-center pt-1 relative items-center w-fit mx-auto px-10 text-sm font-medium",
        ...
        weekdays: "flex",
        weekday:
          "text-zinc-500 rounded-md w-8 font-normal text-[0.8rem] dark:text-zinc-400 flex-none",
        week: "flex w-full mt-2",
        day: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-zinc-100 [&:has([aria-selected].day-outside)]:bg-zinc-100/50 [&:has([aria-selected].day-range-end)]:rounded-r-md dark:[&:has([aria-selected])]:bg-zinc-800 dark:[&:has([aria-selected].day-outside)]:bg-zinc-800/50 w-8 flex-none",
          props.mode === "range"
